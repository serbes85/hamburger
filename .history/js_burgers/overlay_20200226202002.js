...
(function() {
  ...
  let accordeonTeam = document.querySelector(".accordeon");
  let accordeonTeamItemActive = document.querySelector(".accordeon__item--active");;
	...
	accordeonTeam.addEventListener("click", function(event) {
		...
		if (accordeonTeamItem) {
			accordeonTeamItem.classList.toggle("accordeon__item--active");
    } 

    if (!accordeonTeamItemActive) {
			accordeonTeamItemActive.classList.remove("accordeon__item--active");
    } 
