...
(function() {
	...
	console.log(items);
	let currentActiveElement = Array.prototype.find.call(items, elem => elem.classList.contains("accordeon__item--active"));
console.log(currentActiveElement)
	accordeonTeam.addEventListener("click", function(event) {
		...
		if (currentActiveElement !== accordeonTeamItem) {
			currentActiveElement && currentActiveElement.classList.remove("accordeon__item--active");
			currentActiveElement = accordeonTeamItem;
			currentActiveElement.classList.add("accordeon__item--active");
		} else {
